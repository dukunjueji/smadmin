...
public class DemoDaoImpl extends CarIsIbatisDaoImpl implements DemoDao {
    ...
    public List<Demo> getList() {
        return this.queryForList("com.uc.training.smadmin.demo.dao.DemoDao.getList");
    }

    @Override
    public List<DemoRE> getDemoList(DemoListVO demoListVO) {
        return this.queryForList("com.uc.training.smadmin.demo.dao.DemoDao.getDemoList", demoListVO);
    }

    @Override
    public Long getDemoListCount(DemoListVO demoListVO) {
        return (Long) this.queryForObject("com.uc.training.smadmin.demo.dao.DemoDao.getDemoListCount", demoListVO);
    }
}
