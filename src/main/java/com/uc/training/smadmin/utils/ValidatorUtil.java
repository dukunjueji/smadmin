...
public class ValidatorUtil {
     ...
     * 大写字母
     */
    private static final String V_CAPITAL_LETTER = "^[A-Z]+$";

    /**
     * 小写字母
     */
    private static final String V_LOWER_LETTER = "^[a-z]+$";
     ...
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean isThreeOneDays(String value) {
    ...
    public static boolean isLowerLetter(String value) {
        return match(V_LOWER_LETTER, value);
    }
     ...
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean isCapitalLette(String value) {
        return match(V_CAPITAL_LETTER, value);
    }
