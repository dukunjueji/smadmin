...
public class PropertyDaoImpl  extends CarIsIbatisDaoImpl implements PropertyDao{
    ...
    public Long insertProperty(Property property) {
        return (Long) this.insert("com.uc.training.smadmin.gds.dao.CategoryDao.getCategoryList", property);
    }
    ...
    public Integer updateProperty(Property property) {
        return update("com.uc.training.smadmin.gds.dao.CategoryDao.getCategoryList", property);
    }
}
